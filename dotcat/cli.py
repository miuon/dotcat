''' CLI for dotcat command (DOTfile conCATenator).'''
import os
...
from dotcat.constants import (DOTCAT_DIR, DEPLOYED_HOST, ACTIVE_THEME_PATH,
                              ACTIVE_COLOR_PATH)
from dotcat.themeengine import ThemeEngine
from dotcat.utils import get_deployed_host, link_atomic
